...
export default function SocialTab({ likes, comments, blogId, user, isliked }) {
  ...
  const [allLikes, setAllLikes] = useState(likes ?? 0);
  ...
  return (
    <div className="flex items-center justify-between p-4 bg-white shadow rounded-lg hover:bg-gray-100 transition-all duration-500 ease-in-out">
      <div className="flex items-center space-x-4">
        <div className="group relative">
          ...
          <div className="opacity-0 group-hover:opacity-100 absolute top-full left-1/2 transform -translate-x-1/2 mt-2 p-4 bg-white rounded-lg shadow-lg z-10 transition-opacity duration-300">
            <p>Like</p>
          </div>
        </div>
